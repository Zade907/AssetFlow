  ...
  return (
    <main className="grid min-h-[100dvh] place-items-center bg-[var(--surface)] px-5">
      <div className="max-w-md text-center">
        ...
        <Link className="mt-6 inline-flex min-h-10 items-center justify-center rounded-lg bg-[var(--primary)] px-4 text-sm font-medium text-white transition-colors hover:bg-[var(--primary-hover)] active:translate-y-px" to="/">Return to dashboard</Link>
      </div>
    </main>
  );
}
