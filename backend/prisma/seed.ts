...
async function main() {
  ...
  // ------------------------------------------------------------------
  const categoryLookup = await prisma.assetCategory.findMany({ select: { id: true, name: true } });
  ...
  const assetSeeds: Array<{
    ...
    { assetTag: "AF-0001", name: "MacBook Pro 14\"", categoryName: "Electronics", serialNumber: "MBP-14-0001", location: "IT Storage · 3F", acquisitionCost: "180000.00", isBookable: false },
    { assetTag: "AF-0002", name: "ThinkPad X1 Carbon", categoryName: "Electronics", serialNumber: "TP-X1-0002", location: "IT Storage · 3F", acquisitionCost: "145000.00", isBookable: false },
    { assetTag: "AF-0003", name: "Meeting Room B2", categoryName: "Rooms", location: "3rd Floor · West Wing", acquisitionCost: "0.00", isBookable: true, condition: AssetCondition.GOOD },
    { assetTag: "AF-0004", name: "Meeting Room C1", categoryName: "Rooms", location: "4th Floor · East Wing", acquisitionCost: "0.00", isBookable: true, condition: AssetCondition.GOOD },
    { assetTag: "AF-0005", name: "Portable Projector", categoryName: "Electronics", serialNumber: "PROJ-EP-0005", location: "AV Cart · 3F", acquisitionCost: "42000.00", isBookable: true },
    { assetTag: "AF-0006", name: "Pool Van", categoryName: "Vehicles", serialNumber: "MH12-VAN-0006", location: "Basement Parking", acquisitionCost: "780000.00", isBookable: true },
  ];
    ...
    if (!existingRequest) {
      await prisma.maintenanceRequest.create({
        data: {
          assetId: thinkpadId,
          raisedById: arjunId,
          description: "Battery drains within 90 minutes even on light workloads; replace battery pack.",
  ...
  console.log("Seed complete: 3 departments, 5 categories, 8 employees, 6 assets, 1 booking, 1 maintenance request.");
